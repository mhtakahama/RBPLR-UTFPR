...
if tf==1
    ...
    diretorio_arquivo=[dir_path '\' file_name]; %Diretorio do arquivo lido
    ...
    % torque=2.5*downsample(torque_orig',DATA_aqs_rate(6));
    torque=torque';
...
csvwrite([dir_path '\' file_name '.txt'],salvar_dados)
...
writetable(T,[dir_path '\' file_name '_tabela.csv'])
